        ...
        _this._onRenderHeader = function (props, defaultRender, headerTextId) {
            ...
            if (headerText) {
                return (React.createElement("div", { className: _this._classNames.header },
                    React.createElement("div", tslib_1.__assign({ id: headerTextId, role: "heading", "aria-level": 2 }, headerTextProps, { className: Utilities_1.css(_this._classNames.headerText, headerTextProps.className) }), headerText)));
            }
            return null;
        };
