...
var GroupedListSection = /** @class */ (function (_super) {
    ...
    function GroupedListSection(props) {
        ...
        _this._getGroupDragDropOptions = function () {
            ...
            var canDrag = dragDropEvents.canDragGroups ? function () { return dragDropEvents.canDragGroups; } : function () { return false; };
            var options = {
    ...
    GroupedListSection.prototype._onRenderGroup = function (renderCount) {
        ...
        return (React.createElement(List, __assign({ role: groupProps && groupProps.role ? groupProps.role : 'grid', items: items, onRenderCell: this._onRenderGroupCell(onRenderCell, groupNestingDepth), ref: this._list, renderCount: Math.min(count, renderCount), startIndex: startIndex, onShouldVirtualize: onShouldVirtualize, id: this._id }, listProps)));
    };
