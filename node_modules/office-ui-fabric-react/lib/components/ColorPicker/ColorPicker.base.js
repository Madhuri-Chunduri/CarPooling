...
var ColorPickerBase = /** @class */ (function (_super) {
    ...
    function ColorPickerBase(props) {
        ...
        _this._strings = __assign(__assign({}, defaultStrings), strings);
        return _this;
    }
            ...
            React.createElement("div", { className: classNames.panel },
                ...
                React.createElement("div", { className: classNames.flexContainer },
                    React.createElement("div", { className: classNames.flexSlider },
                        React.createElement(ColorSlider, { className: "is-hue", 
                            // tslint:disable-next-line:deprecation
                            ariaLabel: strings.hue || strings.hueAriaLabel, minValue: 0, maxValue: MAX_COLOR_HUE, value: color.h, onChange: this._onHChanged }),
                        !alphaSliderHidden && (React.createElement(ColorSlider, { className: "is-alpha", isAlpha: true, ariaLabel: strings.alphaAriaLabel || textLabels.a, overlayColor: color.hex, minValue: 0, maxValue: MAX_COLOR_ALPHA, value: color.a, onChange: this._onAChanged }))),
