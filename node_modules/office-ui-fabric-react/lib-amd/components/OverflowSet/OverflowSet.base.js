define(["require", "exports", "tslib", "react", "../../FocusZone", "../../Utilities", "../../utilities/keytips/KeytipManager"], function (require, exports, tslib_1, React, FocusZone_1, Utilities_1, KeytipManager_1) {
    ...
    var OverflowSetBase = /** @class */ (function (_super) {
        ...
        OverflowSetBase.prototype.render = function () {
            // tslint:disable-next-line:deprecation
            var _a = this.props, items = _a.items, overflowItems = _a.overflowItems, className = _a.className, focusZoneProps = _a.focusZoneProps, styles = _a.styles, vertical = _a.vertical, doNotContainWithinFocusZone = _a.doNotContainWithinFocusZone, role = _a.role;
            ...
            if (doNotContainWithinFocusZone) {
                ...
                uniqueComponentProps = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, Utilities_1.getNativeProps(this.props, Utilities_1.divProperties)), focusZoneProps), { componentRef: this._focusZone, direction: vertical ? FocusZone_1.FocusZoneDirection.vertical : FocusZone_1.FocusZoneDirection.horizontal });
            }
