define(["require", "exports", "tslib", "react", "../../Utilities", "../../OverflowSet", "../../ResizeGroup", "../../FocusZone", "../../Utilities", "../../Button", "../../Tooltip", "@uifabric/utilities", "@uifabric/styling"], function (require, exports, tslib_1, React, Utilities_1, OverflowSet_1, ResizeGroup_1, FocusZone_1, Utilities_2, Button_1, Tooltip_1, utilities_1, styling_1) {
    "use strict";
    ...
    var CommandBarBase = /** @class */ (function (_super) {
        ...
        function CommandBarBase() {
            ...
            _this._onRenderItem = function (item) {
                ...
                var commandButtonProps = tslib_1.__assign(tslib_1.__assign({ allowDisabledFocus: true, role: 'menuitem' }, item), { styles: tslib_1.__assign(tslib_1.__assign({}, item.buttonStyles), { root: item.buttonStyles ? styling_1.mergeStyles(rootStyles, item.buttonStyles.root) : rootStyles, label: item.buttonStyles ? styling_1.mergeStyles(labelStyles, item.buttonStyles.label) : labelStyles }), className: Utilities_1.css('ms-CommandBarItem-link', item.className), text: !item.iconOnly ? itemText : undefined, menuProps: item.subMenuProps, onClick: _this._onButtonClick(item) });
            ...
            _this._onRenderOverflowButton = function (overflowItems) {
                var _a = _this.props.overflowButtonProps // assure that props is not empty
