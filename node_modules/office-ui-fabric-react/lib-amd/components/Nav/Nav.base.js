    ...
    var NavBase = /** @class */ (function (_super) {
        ...
        function NavBase(props) {
            ...
            _this._renderGroupHeader = function (group) {
                ...
                return (React.createElement("button", { className: classNames.chevronButton, onClick: _this._onGroupHeaderClicked.bind(_this, group), "aria-label": label, "aria-expanded": isExpanded },
        ...
        NavBase.prototype._renderNavLink = function (link, linkIndex, nestingLevel) {
            var _a = this.props, styles = _a.styles, groups = _a.groups, theme = _a.theme, selectedAriaLabel = _a.selectedAriaLabel;
            ...
            var onRenderLink = this.props.onRenderLink ? utilities_1.composeRenderFunction(this.props.onRenderLink, this._onRenderLink) : this._onRenderLink;
            return (React.createElement(LinkAs, { className: classNames.link, styles: Nav_styles_1.buttonStyles, href: link.url || (link.forceAnchor ? '#' : undefined), iconProps: link.iconProps || { iconName: link.icon }, onClick: link.onClick ? this._onNavButtonLinkClicked.bind(this, link) : this._onNavAnchorLinkClicked.bind(this, link), title: link.title !== undefined ? link.title : link.name, target: link.target, rel: rel, disabled: link.disabled, "aria-label": link.ariaLabel && selectedStateAriaLabel
                    ...
                    : selectedStateAriaLabel
                        ...
                        : link.ariaLabel
                            ? link.ariaLabel
                            : undefined, link: link }, onRenderLink(link)));
        };
        ...
        NavBase.prototype._toggleCollapsed = function (group) {
            var _a;
            if (group.name) {
                var newGroupCollapsed = tslib_1.__assign(tslib_1.__assign({}, this.state.isGroupCollapsed), (_a = {}, _a[group.name] = this._isGroupExpanded(group) // sic - presently open will be collapsed after setState
                , _a));
