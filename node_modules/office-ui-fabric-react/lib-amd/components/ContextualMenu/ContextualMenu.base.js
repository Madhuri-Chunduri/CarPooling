    ...
    var ContextualMenuBase = /** @class */ (function (_super) {
        ...
        function ContextualMenuBase(props) {
            ...
            _this._shouldCloseSubMenu = function (ev) {
                var submenuCloseKey = Utilities_2.getRTL(_this.props.theme) ? Utilities_2.KeyCodes.right : Utilities_2.KeyCodes.left;
            ...
            _this._onItemKeyDown = function (item, ev) {
                var openKey = Utilities_2.getRTL(_this.props.theme) ? Utilities_2.KeyCodes.left : Utilities_2.KeyCodes.right;
                if (!item.disabled &&
            ...
            _this._id = props.id || Utilities_2.getId('ContextualMenu');
        ...
        ContextualMenuBase.prototype._renderNormalItem = function (item, 
        // tslint:disable-next-line:deprecation
        ...
        ContextualMenuBase.prototype._getSubmenuProps = function () {
            ...
            if (item) {
                submenuProps = {
                    ...
                    directionalHint: Utilities_2.getRTL(this.props.theme) ? DirectionalHint_1.DirectionalHint.leftTopEdge : DirectionalHint_1.DirectionalHint.rightTopEdge,
        ...
        ContextualMenuBase.prototype._setTargetWindowAndElement = function (target) {
            ...
            if (target) {
                if (typeof target === 'string') {
                    var currentDoc = Utilities_2.getDocument(currentElement);
                    this._target = currentDoc ? currentDoc.querySelector(target) : null;
                    this._targetWindow = Utilities_2.getWindow(currentElement);
                }
                else if (!!target.stopPropagation) {
                    this._targetWindow = Utilities_2.getWindow(target.target);
                    this._target = target;
                }
