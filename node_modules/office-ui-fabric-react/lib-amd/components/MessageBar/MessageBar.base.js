define(["require", "exports", "tslib", "react", "../../Utilities", "../../Button", "../../Icon", "./MessageBar.types", "@uifabric/utilities"], function (require, exports, tslib_1, React, Utilities_1, Button_1, Icon_1, MessageBar_types_1, utilities_1) {
    "use strict";
    ...
    var MessageBarBase = /** @class */ (function (_super) {
        ...
        MessageBarBase.prototype._getDismissDiv = function () {
            ...
            if (onDismiss) {
                return (React.createElement(Button_1.IconButton, { disabled: false, className: this._classNames.dismissal, onClick: onDismiss, iconProps: dismissIconProps ? dismissIconProps : { iconName: 'Clear' }, ariaLabel: this.props.dismissButtonAriaLabel }));
            }
            return null;
        };
        ...
        MessageBarBase.prototype._renderMultiLine = function () {
            ...
            return (React.createElement("div", { style: { background: theme.semanticColors.bodyBackground } },
                React.createElement("div", tslib_1.__assign({ className: this._classNames.root }, this._getRegionProps()),
        ...
        MessageBarBase.prototype._renderInnerText = function () {
            var nativeProps = Utilities_1.getNativeProps(this.props, Utilities_1.htmlElementProperties, ['className']);
