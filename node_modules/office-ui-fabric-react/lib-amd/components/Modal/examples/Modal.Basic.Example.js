define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Utilities", "office-ui-fabric-react", "@uifabric/styling"], function (require, exports, tslib_1, React, Utilities_1, office_ui_fabric_react_1, styling_1) {
    "use strict";
    ...
    var iconButtonStyles = office_ui_fabric_react_1.mergeStyleSets({
        root: {
            color: theme.palette.neutralPrimary,
            marginLeft: 'auto',
            marginTop: '4px',
    ...
    var ModalBasicExample = /** @class */ (function (_super) {
        ...
        ModalBasicExample.prototype.render = function () {
            return (React.createElement("div", null,
                React.createElement(office_ui_fabric_react_1.Checkbox, { styles: { root: { marginBottom: '20px' } }, label: "Is draggable", onChange: this._toggleDraggable, checked: this.state.isDraggable }),
                React.createElement(office_ui_fabric_react_1.DefaultButton, { secondaryText: "Opens the Sample Modal", onClick: this._showModal, text: "Open Modal" }),
                React.createElement(office_ui_fabric_react_1.Modal, { titleAriaId: this._titleId, subtitleAriaId: this._subtitleId, isOpen: this.state.showModal, onDismiss: this._closeModal, isBlocking: false, containerClassName: contentStyles.container, dragOptions: this.state.isDraggable ? this._dragOptions : undefined },
                    React.createElement("div", { className: contentStyles.header },
                        React.createElement("span", { id: this._titleId }, "Lorem Ipsum"),
                        React.createElement(office_ui_fabric_react_1.IconButton, { styles: iconButtonStyles, iconProps: { iconName: 'Cancel' }, ariaLabel: "Close popup modal", onClick: this._closeModal })),
