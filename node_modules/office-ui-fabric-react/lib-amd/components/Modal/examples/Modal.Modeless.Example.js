define(["require", "exports", "tslib", "react", "office-ui-fabric-react", "@uifabric/styling", "office-ui-fabric-react/lib/Utilities"], function (require, exports, tslib_1, React, office_ui_fabric_react_1, styling_1, Utilities_1) {
    "use strict";
    ...
    var ModalModelessExample = /** @class */ (function (_super) {
        ...
        ModalModelessExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                React.createElement(office_ui_fabric_react_1.Checkbox, { styles: { root: { marginBottom: '20px' } }, label: "Is draggable", onChange: this._toggleDraggable, checked: isDraggable, disabled: showModal }),
                ...
                React.createElement(office_ui_fabric_react_1.Modal, { titleAriaId: this._titleId, subtitleAriaId: this._subtitleId, isOpen: showModal, onDismiss: this._closeModal, isModeless: true, containerClassName: contentStyles.container, dragOptions: isDraggable ? this._dragOptions : undefined },
