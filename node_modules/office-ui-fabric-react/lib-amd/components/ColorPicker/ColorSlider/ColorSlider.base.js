define(["require", "exports", "tslib", "react", "../../../Utilities", "../../../utilities/color/clamp"], function (require, exports, tslib_1, React, Utilities_1, clamp_1) {
    "use strict";
    ...
    var ColorSliderBase = /** @class */ (function (_super) {
        ...
        function ColorSliderBase(props) {
            ...
            _this._onKeyDown = function (ev) {
                ...
                _this._updateValue(ev, clamp_1.clamp(currentValue, maxValue, minValue));
            };
            ...
            _this._onMouseMove = function (ev) {
                ...
                var newValue = clamp_1.clamp(Math.round(currentPercentage * maxValue), maxValue, minValue);
        ...
        ColorSliderBase.prototype.render = function () {
            ...
            return (React.createElement("div", { ref: this._root, className: classNames.root, tabIndex: 0, onKeyDown: this._onKeyDown, onMouseDown: this._onMouseDown, role: "slider", "aria-valuenow": currentValue, "aria-valuetext": String(currentValue), "aria-valuemin": minValue, "aria-valuemax": maxValue, "aria-label": ariaLabel, "data-is-focusable": true },
                !!(overlayColor || overlayStyle) && (React.createElement("div", { className: classNames.sliderOverlay, 
                    ...
                    style: overlayColor !== undefined ? { background: "linear-gradient(to right, transparent 0, #" + overlayColor + " 100%)" } : overlayStyle })),
