define(["require", "exports", "tslib", "react", "../../Utilities", "./Fabric.styles", "../../Styling"], function (require, exports, tslib_1, React, Utilities_1, Fabric_styles_1, Styling_1) {
    "use strict";
    ...
    var getDir = Utilities_1.memoizeFunction(function (theme, dir) {
        if (dir) {
            return dir;
        }
        ...
        return Utilities_1.getRTL() ? 'rtl' : 'ltr';
    });
    var FabricBase = /** @class */ (function (_super) {
        ...
        FabricBase.prototype.render = function () {
            ...
            var renderedContent = React.createElement(Root, tslib_1.__assign({ dir: componentDir }, divProps, { className: classNames.root, ref: this._rootElement }));
        ...
        FabricBase.prototype.componentDidMount = function () {
            ...
            if (win) {
                this._disposables.push(Utilities_1.on(win, 'mousedown', this._onMouseDown, true), Utilities_1.on(win, 'keydown', this._onKeyDown, true), Utilities_1.on(win, 'pointerdown', this._onPointerDown, true));
            }
